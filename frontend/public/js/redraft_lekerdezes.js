...
const AdatokLekereseAdatbazisbol = ()=>{
    let adatok =[];
    fetch("http://127.0.0.1:3000/redraft")
    .then((res)=>{
        if(!res.ok)
...
function positionAll(){
    ...
    const AdatokLekereseAdatbazisbol = ()=>{
        let adatok =[];
        console.log(adatok)
        fetch("http://127.0.0.1:3000/redraftall")
        .then((res)=>{
            if(!res.ok)
                console.log("Hiba lépett fel az adatbázis kapcsolat létrehozása során");
            else
...
function positionQb(){
    ...
    const AdatokLekereseAdatbazisbol = ()=>{
        let adatok =[];
        console.log(adatok)
        fetch("http://127.0.0.1:3000/redraftqb")
        .then((res)=>{
            if(!res.ok)
                console.log("Hiba lépett fel az adatbázis kapcsolat létrehozása során");
            else
...
function positionRb(){
    ...
    const AdatokLekereseAdatbazisbol = ()=>{
        let adatok =[];
        console.log(adatok)
        fetch("http://127.0.0.1:3000/redraftrb")
        .then((res)=>{
            if(!res.ok)
                console.log("Hiba lépett fel az adatbázis kapcsolat létrehozása során");
            else
...
function positionWr(){
    ...
    const AdatokLekereseAdatbazisbol = ()=>{
        let adatok =[];
        console.log(adatok)
        fetch("http://127.0.0.1:3000/redraftwr")
        .then((res)=>{
            if(!res.ok)
                console.log("Hiba lépett fel az adatbázis kapcsolat létrehozása során");
            else
...
function positionTe(){
    ...
    const AdatokLekereseAdatbazisbol = ()=>{
        let adatok =[];
        console.log(adatok)
        fetch("http://127.0.0.1:3000/redraftte")
        .then((res)=>{
            if(!res.ok)
                console.log("Hiba lépett fel az adatbázis kapcsolat létrehozása során");
            else
