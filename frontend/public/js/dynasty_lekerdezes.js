...
function positionAll(){
    ...
    const AdatokLekereseAdatbazisbol = ()=>{
        let adatok =[];
        console.log(adatok)
        fetch("http://127.0.0.1:3000/dynastyall")
        .then((res)=>{
            if(!res.ok)
                console.log("Hiba lépett fel az adatbázis kapcsolat létrehozása során");
            else
...
function positionQb(){
    ...
    const AdatokLekereseAdatbazisbol = ()=>{
        let adatok =[];
        console.log(adatok)
        fetch("http://127.0.0.1:3000/dynastyqb")
        .then((res)=>{
            if(!res.ok)
                console.log("Hiba lépett fel az adatbázis kapcsolat létrehozása során");
            else
...
function positionRb(){
    ...
    const AdatokLekereseAdatbazisbol = ()=>{
        let adatok =[];
        console.log(adatok)
        fetch("http://127.0.0.1:3000/dynastyrb")
        .then((res)=>{
            if(!res.ok)
                console.log("Hiba lépett fel az adatbázis kapcsolat létrehozása során");
            else
...
function positionWr(){
    ...
    const AdatokLekereseAdatbazisbol = ()=>{
        let adatok =[];
        console.log(adatok)
        fetch("http://127.0.0.1:3000/dynastywr")
        .then((res)=>{
            if(!res.ok)
                console.log("Hiba lépett fel az adatbázis kapcsolat létrehozása során");
            else
...
function positionTe(){
    ...
    const AdatokLekereseAdatbazisbol = ()=>{
        let adatok =[];
        console.log(adatok)
        fetch("http://127.0.0.1:3000/dynastyte")
        .then((res)=>{
            if(!res.ok)
                console.log("Hiba lépett fel az adatbázis kapcsolat létrehozása során");
            else
